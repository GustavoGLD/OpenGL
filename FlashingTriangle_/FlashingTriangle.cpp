...
int main(){
    ...
    float vertices[] = {
         0.5f, -0.5, 0.0f, //inferior direito
        -0.5f, -0.5, 0.0f, //inferior esquerdo
         0.0f,  0.5, 0.0f  //em cima
    };
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        //Fazer a intensidade variar de 0 a 1 (usando seno)
        float greenValue = sin(timeValue * 5) / 2 + 0.5f;

        //Pegar ID do local da nossa input da vertexShader "ourColor"
        int vertexColorLocation = glGetUniformLocation(shaderProgram, "ourColor");

        //Definir ourColor (definirá a cor do triângulo)
