...
int main(){
    ...
    //Criar arrays de VBOs e VAOs
    unsigned int VBOs[2], VAOs[2];
    glGenVertexArrays(2, VAOs);
    glGenBuffers(2, VBOs);

    //Criar contexto com o primeiro VBO e VAO do array
    ...
    //Criar contexto com o segundo VBO e VAO do array
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        //Desenhar primeiro triângulo
        glBindVertexArray(VAOs[0]);
        glDrawArrays(GL_TRIANGLES, 0, 3);

        //Desenhar segundo triângulo
        glBindVertexArray(VAOs[1]);
        glDrawArrays(GL_TRIANGLES, 0, 3);
